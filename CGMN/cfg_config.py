...
parser.add_argument(
    "--dataset", type=str, default="OpenSSL", help="indicate the specific data set"
)
parser.add_argument(
    "--graph_size_min", type=int, default=50, help="min node size for one graph "
)
parser.add_argument(
    "--graph_size_max", type=int, default=200, help="max node size for one graph "
)
parser.add_argument(
    "--graph_init_dim", type=int, default=6, help="init feature dimension for one graph"
)
...
parser.add_argument(
    ...
    type=str,
    default="100_100_100",
    help="Filters (neurons) dimensions for graph convolution network",
)
parser.add_argument(
    "--conv", type=str, default="gcn", help="Kind of node message passing layer"
)
parser.add_argument(
    "--match", type=str, default="concat", help="indicating the matching method"
)
parser.add_argument(
    "--perspectives", type=int, default=100, help="number of perspectives for matching"
)
...
parser.add_argument(
    "--batch_size", type=int, default=5, help="Number of graph pairs per batch."
)
...
parser.add_argument(
    "--log_path", type=str, default="../CFGLogs/", help="path for log file"
)
parser.add_argument(
    "--repeat_run", type=int, default=1, help="indicated the index of repeat run"
)
