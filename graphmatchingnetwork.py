...
from evaluation import compute_cross_attention_scores, compute_similarity
from graphembeddingnetwork import GraphEmbeddingNet, GraphPropLayer
...
class GraphPropMatchingLayer(GraphPropLayer):
    ...
    def forward(
        ...
        # ca = (
        #     torch.load("cross_attentions.pt")
        #     if path.exists("cross_attentions.pt")
        #     else []
        # )
        # ca.append((a_x_s, a_y_s))
        # torch.save(ca, "cross_attentions.pt")

        # tk = (
        #     torch.load("topk_cross_attentions.pt")
        #     if path.exists("topk_cross_attentions.pt")
        #     else []
        # )
        # tk.append(topk_cross_attentions)
        # torch.save(tk, "topk_cross_attentions.pt")
